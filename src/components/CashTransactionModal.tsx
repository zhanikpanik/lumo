...
const CONFIG = {
  in: {
    ...
    cta: 'Внести',
    cta_color: '#1976D2',
    note_placeholder: 'Например: размен в начале смены',
  ...
  out: {
    ...
    cta: 'Изъять',
    cta_color: '#F57C00',
    note_placeholder: 'Например: размен / возврат сдачи',
    hint: 'Сумма не может превысить наличку в кассе.',
  },
} as const;

export const CashTransactionModal: React.FC<Props> = ({ visible, mode, onClose, onConfirm }) => {
        ...
        <View style={styles.modal}>
          ...
          <View style={styles.body}>
            ...
            <TextInput
              ...
              placeholder={cfg.note_placeholder}
              placeholderTextColor={theme.colors.textSecondary}
            />
          </View>
          ...
          <View style={styles.actions}>
            ...
            <TouchableOpacity
              style={[styles.confirmBtn, { backgroundColor: cfg.cta_color }]}
